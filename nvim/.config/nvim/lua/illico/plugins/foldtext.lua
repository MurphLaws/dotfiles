return {
	...
	config = function()
		...
		-- Colores de los iconos/títulos en el foldtext.
		local function hls()
			vim.api.nvim_set_hl(0, "FtJornada", { fg = "#cba6f7", bold = true }) -- malva
			vim.api.nvim_set_hl(0, "FtBloque", { fg = "#89b4fa", bold = true }) -- azul
			vim.api.nvim_set_hl(0, "FtEjercicio", { fg = "#fab387", bold = true }) -- durazno
			vim.api.nvim_set_hl(0, "FtHeading", { fg = "#bac2de" }) -- texto normal
		end
		hls()
