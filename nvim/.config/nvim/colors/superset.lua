...
-- markdown / docs
hl("@markup.heading",       { fg = p.mauve, bold = true })
hl("@markup.heading.1",     { fg = p.mauve, bold = true })
hl("@markup.heading.2",     { fg = p.purple, bold = true })
hl("@markup.heading.3",     { fg = p.blue,  bold = true })
hl("@markup.heading.4",     { fg = p.sky,   bold = true })
hl("@markup.heading.5",     { fg = p.green, bold = true })
hl("@markup.heading.6",     { fg = p.gold,  bold = true })
...
-- todo-comments
-- todo-comments (group names MUST match the keywords in todo_comments.lua:
-- TODO, DONE, FIXIT, BUGGED, OPTIM, POINTER)
hl("TodoFgTODO",    { fg = p.sky,     bold = true })
hl("TodoFgDONE",    { fg = p.green,   bold = true })
hl("TodoFgFIXIT",   { fg = p.amber,   bold = true })
hl("TodoFgBUGGED",  { fg = p.red,     bold = true })
hl("TodoFgOPTIM",   { fg = "#F97316" })
hl("TodoFgPOINTER", { fg = "#FF7A00", bold = true })
hl("TodoBgTODO",    { fg = p.bg, bg = p.sky,     bold = true })
hl("TodoBgDONE",    { fg = p.bg, bg = p.green,   bold = true })
hl("TodoBgFIXIT",   { fg = p.bg, bg = p.amber,   bold = true })
hl("TodoBgBUGGED",  { fg = p.bg, bg = p.red,     bold = true })
hl("TodoBgOPTIM",   { fg = p.bg, bg = "#F97316" })
hl("TodoBgPOINTER", { fg = p.bg, bg = "#FF7A00", bold = true })
