...
tap "gromgit/fuse"
tap "haseebkhalid1507/tap", "https://github.com/HaseebKhalid1507/homebrew-tap"
tap "hmenzagh/tap"
...
brew "haseebkhalid1507/tap/myx", link: false, trusted: true
# Spotify client for the terminal written in Rust, powered by Ratatui
brew "largemodgames/spotatui/spotatui", trusted: true
# Real-time network bandwidth monitor for the terminal
brew "programmersd21/flow/flow", trusted: true
