# Generated by Powerlevel10k configuration wizard on 2026-08-13 at 13:59 -05.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( VCS_STATUS_COMMITS_AHEAD || VCS_STATUS_COMMITS_BEHIND )); then
      # ⇣42 if behind the remote (commits to pull).
      (( VCS_STATUS_COMMITS_BEHIND )) && res+=" ${clean}⇣${VCS_STATUS_COMMITS_BEHIND}"
      # ⇡42 if ahead of the remote (commits to push); no leading space if also behind: ⇣42⇡42.
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#73daca'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND='#73daca'
  typeset -g POWERLEVEL9K_STATUS_OK_VISUAL_IDENTIFIER_EXPANSION='ok'

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND='#73daca'
  ...
  ##############[ taskwarrior: taskwarrior task count (https://taskwarrior.org/) ]##############
  # Taskwarrior color.
  typeset -g POWERLEVEL9K_TASKWARRIOR_FOREGROUND='#73daca'
  ...
  typeset -g POWERLEVEL9K_CPU_ARCH_FOREGROUND='#bb9af7'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND='#565f89'
