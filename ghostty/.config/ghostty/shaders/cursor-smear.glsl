// Animación de cursor tipo "smear" (estilo Neovide).
// Fuente: https://github.com/sahaj-b/ghostty-cursor-shaders (cursor_warp.glsl)
//
// Debe ir DESPUÉS del shader de gradiente en el config: sobre fondo
// transparente el rastro hereda el alpha del fondo, y el gradiente ya le da un
// alpha real (BG_OPACITY), así el rastro se vuelve visible.
